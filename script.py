# Create the fixed version with both issues resolved
fixed_zelda_game = '''# Zelda The Lich King Tales
    ...
    def on_show_view(self):
        ...
        if music_player is None:
            if os.path.exists(MUSIC_FILE):
                ...
                music_player = arcade.play_sound(sound, volume=0.4, looping=True)
...
with open("my_zelda_game_fixed.py", "w") as f:
    f.write(fixed_zelda_game)

print("✅ FIXED VERSION CREATED!")
print("📁 File: my_zelda_game_fixed.py")
print()
print("🔧 FIXES APPLIED:")
print("=" * 30)
print("1. ✅ MUSIC FIX:")
print("   - Added global music_player variable")
print("   - Music only plays once (checks if already playing)")
print("   - Stops music only when quitting game")
print()
print("2. ✅ MENU SELECTION FIX:")
print("   - MenuScreen now takes initial_selected parameter")
print("   - GameScreen returns to 'Start' (0)")
print("   - SettingsScreen returns to 'Settings' (1)")
print("   - AboutScreen returns to 'About' (2)")
print()
print("🎮 NOW YOUR GAME WILL:")
print("• Play music only once, no overlapping")
print("• Remember which menu option you came from")
print("• Only stop music when actually quitting")
print()
print("Replace your current file with this fixed version!")